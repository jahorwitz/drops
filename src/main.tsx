...
import { GlucoseNotificationPrompt, Start, Welcome, RegistrationConfirmation, SetDietGoals } from "./routes";
    ...
    <ApolloProvider client={client}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/onboarding/diet-goal-reminder" element={<SetDietGoals />}/>
