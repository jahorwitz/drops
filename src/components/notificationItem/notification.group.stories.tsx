...
import { NotificationGroup, NotificationGroupProps } from "./notification-group";
...
export const NotificationGroupStory: Story<NotificationGroupProps> = (args) => {
    const [notifications, setNotifications] = useState(args.notifications);
    const handleRemove = (index: number) => {
        setNotifications((prev) => prev.filter((_,i) => i !== index)); 
    }; 

    return <NotificationGroup notifications ={notifications} onRemove={handleRemove}/>
}; 
