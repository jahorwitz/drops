      ...
      <div className="flex flex-col gap-1 leading-5 text-base font-normal font-text z-10">
        ...
        <Listbox value={selected} onChange={(o) => {
          ...
          <div className="relative">
            <Listbox.Button className={cx("w-full relative border-2 rounded-lg py-5 px-3 focus:outline-none focus:border-blue-500 flex", selected ? "border-black" : "border-gray-300")}>
